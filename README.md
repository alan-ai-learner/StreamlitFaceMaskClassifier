...
# Motivation
- In this lockdown and Covid-19 period i think i can use my **Computer Vision Skills** to made a classifier which can be used to classify the picture of a person, that he/she wearing a mask or not.
...
# License
 MIT License
Copyright (c) 2020 Alankar Shukla
